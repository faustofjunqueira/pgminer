...
/* Function: fann_get_cascade_activation_functions
   ...
   The default activation functions is {NN_SIGMOID, NN_SIGMOID_SYMMETRIC, NN_GAUSSIAN, NN_GAUSSIAN_SYMMETRIC, NN_ELLIOT, NN_ELLIOT_SYMMETRIC}
   ...
   See also:
	...
	This function appears in FANN >= 2.0.0.
 */
FANN_EXTERNAL enum nn_ActivationFuncEnum * FANN_API fann_get_cascade_activation_functions(
															struct fann *ann);
