...
'$libdir/pgminer.so', 'pgm_create_matrix'
  ...
  COST 1;
ALTER FUNCTION pgm_create_matrix(integer, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_create_vetor_double'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_create_vetor_double(integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_create_vetor_int'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_create_vetor_int(integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_free_matrix'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_free_matrix(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_free_vetor_double'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_free_vetor_double(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_free_vetor_int'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_free_vetor_int(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_matrix_elem'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_matrix_elem(bigint, integer, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_matrix_line'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_matrix_line(bigint, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_vetor_double_elem'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_vetor_double_elem(bigint, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_vetor_int_elem'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_vetor_int_elem(bigint, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_kmeans'
  ...
  COST 1;
ALTER FUNCTION pgm_kmeans(bigint, integer, integer, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_ncols_matrix'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_ncols_matrix(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_nelem_vetor_double'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_nelem_vetor_double(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_nelem_vetor_int'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_nelem_vetor_int(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_nlines_matrix'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_nlines_matrix(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_set_matrix_elem'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_set_matrix_elem(bigint, integer, integer, double precision) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_set_matrix_line'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_set_matrix_line(bigint, integer, double precision[]) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_set_vetor_double_elem'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_set_vetor_double_elem(bigint, integer, double precision) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_set_vetor_int_elem'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_set_vetor_int_elem(bigint, integer, integer) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_matrix'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_matrix(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_vector_int'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_vector_int(bigint) OWNER TO gccbd;
...
'$libdir/pgminer.so', 'pgm_get_vector_double'
  LANGUAGE c VOLATILE STRICT
  COST 1;
ALTER FUNCTION pgm_get_vector_double(bigint) OWNER TO gccbd;
