    ...
    char *argv[];
{
    ...
    Item = (char **) pgm_malloc(ItemSpace * sizeof(char *));
	...
	{
	    ItemSpace += 1000;
	    Item = (char **) pgm_realloc(Item, ItemSpace * sizeof(char *));
	}

	Length = strlen(Line)+2;
	Item[MaxItem] = (char *) pgm_malloc(Length);
    ...
    ClassPtr = (char **) pgm_malloc((MaxItem+1) * sizeof(char *));
    ForEach(i, 0, MaxItem)
    {
