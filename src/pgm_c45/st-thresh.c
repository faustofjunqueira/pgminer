...
/*  ------------  */
    Tree T;
{
    CVals = (float *) pgm_calloc(MaxItem+1, sizeof(float));
    LHSErr = (Boolean *) pgm_calloc(MaxItem+1, sizeof(Boolean));
    RHSErr = (Boolean *) pgm_calloc(MaxItem+1, sizeof(Boolean));
    ThreshErrs = (ItemNo *) pgm_calloc(MaxItem+1, sizeof(ItemNo));
