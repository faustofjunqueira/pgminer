...
/* Function: fann_get_activation_function
   ...
   Information about the individual activation functions is available at <nn_ActivationFuncEnum>.
   ...
   This function appears in FANN >= 2.1.0
 */
FANN_EXTERNAL enum nn_ActivationFuncEnum FANN_API fann_get_activation_function(struct fann *ann,
																int layer,
																int neuron);
...
/* Function: fann_set_activation_function
   ...
   functions have different range. NN_SIGMOID is e.g. in the 0 - 1 range while
   NN_SIGMOID_SYMMETRIC is in the -1 - 1 range and NN_LINEAR is unbound.

   Information about the individual activation functions is available at <nn_ActivationFuncEnum>.

   The default activation function is NN_SIGMOID_STEPWISE.
